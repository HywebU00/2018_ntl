			...
			<div class="row">					
				<article class="col-sm-12 col-md-12">
					...
					<div class="ContentPage CP">			
						...
						<!--書本資訊-->
						<div class="PopBox Articles">
							<div class="Block">
								<!-- Block_Pic  此區塊拿掉即無圖-->
								<!--.TextLink 是文章連結的class setting-->
								<div class="Block_Pic">
									<a class="fancybox-buttons" data-fancybox-group="button" href="images/books/001.jpg" title="那些無止盡的日子"><img src="images/books/001.jpg" class="img-responsive" alt="" /></a>
								</div>
								<div>
									...
									<div class="Block_Text">
										...
										<a href="CP2.php" title="" class="icon-search SearchBook">館藏查詢</a>
								...
								<div class="row Block">
									...
									<div class="col-xs-12 col-sm-9 col-md-9">
										...
										<div class="Block_Text">
											...
											<p>我走回埋在雪中的陷阱撥開雪，以防萬一裡面有遺漏掉的動物。森林比我所見過的更加美麗，但我的腦子裡只想著空手而回的後果……。八歲那年夏天，佩姬的鋼琴家母親烏特在歐洲演出時，<a href="" class="TextLink" title="">爸爸詹姆士</a>帶著她出發前往傳說中的童話木屋「胡特」。年輕的詹姆士是個生存狂，一直在為不久即將來臨的世界末日儲備物資，訓練佩姬迅速逃難、打包的能力。那一天，詹姆士決定前往「胡特」，雖然抵達後才發現只是什麼都沒有的破舊小屋，卻已無法回頭... </p>
										<a href="CP2.php" title="" class="icon-search ReadMore">館藏查詢</a>
										</div>
									</div>
								</div>
							</div>
