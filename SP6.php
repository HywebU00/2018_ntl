			...
			<div class="row">					
				<article class="col-sm-12 col-md-12">
					...
					<div class="ContentPage">
						<h2 class="PageTitle">活動報名</h2>
						<div class="Top-Text">
							<p>報名『研習班課程』請至【活動訊息-->研習班-->課程總覽暨報名】</p>
						</div>
						<!--活動類別-->
						<div class="form-horizontal" style="margin-bottom: 20px;">
							<div class="form-group">
								<label for="inputNo" class="col-md-3 control-label brown">以活動類別進行列表過濾：</label>
								<div class="col-md-9">
										<select class="form-control">
										<option>所有活動類別</option>
										<option>A</option>
										<option>B</option>
										<option>C</option>
									</select>
						...
						<div class="EventList">
							<div class="Block">
								<div class="Block_Title"><a href="" title="" class="Disabled">(114)：二十年來臺灣歷史GIS的發展與展望二十年來臺灣歷史GIS的發展與展望</a></div>
								<div class="Block_Text">
									<div class="inner">
										<dl>
											...
											<dd>臺灣學系列講座</dd>
											<dt>活動日期：</dt>
											<dd>2016/3/12 - 2016/4/10 下午 05:00:00</dd>
											<dt>報名期間：</dt>
							...
							<div class="Block">
								<div class="Block_Title"><a href="" title="">(115)：近代臺灣體育與休閒生活</a></div>
								<div class="Block_Text">
									<div class="inner">
										<dl>
											<dt>活動類別：</dt>
							...
							<div class="Block">
								<div class="Block_Title"><a href="" title="">(116)：臺灣歷史學習型文創桌遊設計</a></div>
								<div class="Block_Text">
									<div class="inner">
										<dl>
											<dt>活動類別：</dt>
